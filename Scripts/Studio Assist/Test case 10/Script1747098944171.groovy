 ...
 * 5. verify element text is present, with id 'Page_DEMOQA/Page_DEMOQA/label_Current Address' with Expected Text 'Current Addres'
 * 6. Close the browser*/
...
WebUI.verifyElementText(findTestObject('Page_DEMOQA/Page_DEMOQA/label_Current Address'), 'Current Address')
