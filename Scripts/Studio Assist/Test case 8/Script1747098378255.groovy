...
* 5. verify element text is present, with id 'Page_DEMOQA/Page_DEMOQA/label_Full Name' with Expected Text 'Full name'
* 6. Close the browser*/
...
WebUI.verifyElementText(findTestObject('Page_DEMOQA/Page_DEMOQA/label_Full Name'), 'Full Name')
