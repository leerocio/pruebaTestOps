 ...
 * 6. Verify element exist with the id 'Page_CURA Healthcare Service/h2_Make Appointment'*/
...
// Verify that the 'Make Appointment' element exists
WebUI.verifyElementExist(findTestObject('Page_CURA Healthcare Service/h2_Make Appointment'), 10)
