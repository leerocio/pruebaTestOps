 ...
 * 5. verify element text is present, with id 'Page_DEMOQA/Page_DEMOQA/label_Email' with Expected Text 'Email'
 * 6. Close the browser*/
...
WebUI.verifyElementText(findTestObject('Page_DEMOQA/Page_DEMOQA/label_Email'), 'Email')
