...
WebUI.click(findTestObject('Object Repository/Page_DEMOQA/Page_DEMOQA/li_Links'))

WebUI.scrollToPosition(0, 150)

WebUI.verifyElementText(findTestObject('Object Repository/Page_DEMOQA/Page_DEMOQA/strong_Following links will send an api call'), 
