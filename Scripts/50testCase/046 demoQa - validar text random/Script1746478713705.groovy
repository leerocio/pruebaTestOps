...
not_run: WebUI.scrollToPosition(0, 400)

WebUI.click(findTestObject('Object Repository/Page_DEMOQA/Page_DEMOQA/span_Dynamic Properties'))

WebUI.scrollToPosition(0, 400)

WebUI.verifyElementText(findTestObject('Object Repository/Page_DEMOQA/Page_DEMOQA/p_This text has random Id'), 'This text has random Id')
